...
$(document).ready(function () {
	...
	$.ajax({
        ...
        t.row.add([
            ...
            "<td><input type='text' class='name' placeholder=''style='width:100%;text-align:right' name='name[]' value='0'></td>",
			"<td><input type='text' class='car' placeholder=''style='width:100%;text-align:right' name='car[]'></td>",
			"<td><input type='text' class='how_long' placeholder=''style='width:100%;text-align:right' name='how_long[]'value='0'></td>",
            "<td><input type='text' class='cost' placeholder=''style='width:100%;text-align:right' name='quantity[]' value='0'></td>",
            "<td><input type='text' placeholder=''style='width:100%;text-align:right' name='total[]'></td></tr>"
        ]).draw(true).nodes()
                .to$()
                .addClass('sum');
